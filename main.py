...
# pokestop : (49, 221, 255) (233, 251, 238)
# pokemon select : (75, 210, 163) (247, 255, 246)
...
# (75, 210, 163)
    ...
    if(pokePickFailsafe[0]>70 and pokePickFailsafe[0]<80 and pokePickFailsafe[1]>200 and pokePickFailsafe[1]<215 and pokePickFailsafe[2]>160 and pokePickFailsafe[2]<170):
        ...
        time.sleep(1)
        device.shell(f'input tap 500 2000')
...
# leave: 111 277
    ...
    if(pokestop[0]>=230 and pokestop[1]>=240 and pokestop[2]>=230 and pokePickFailsafe[0]!=75):
